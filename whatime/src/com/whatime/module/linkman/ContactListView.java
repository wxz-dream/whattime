package com.whatime.module.linkman;
...
public class ContactListView extends Activity
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        String [] linkmans = wNumberStr.split(",");
        wNumStr = new String[linkmans.length];
        if(!wNumberStr.equals(""))
        {
             for(int i=0;i<linkmans.length;i++)
             {
                 wNumStr[i] = linkmans[i].split(":")[1];
             }
        }
        ...
        listView.setOnItemClickListener(new OnItemClickListener()
        {
            public void onItemClick(AdapterView parent, View view, int position, long id)
            {
                ...
                {
                    cb.setChecked(false);
                    numberStr = numberStr.replace("," + contactList.get(position).getContactName()
                ...
                {
                    cb.setChecked(true);
                    numberStr += "," + contactList.get(position).getContactName()
                        +":"+ contactList.get(position).getUserNumber();
        ...
        public void onPostExecute(String Re)
        {
            ...
            else
            {
                ...
                ArrayAdapter<String> adapter =
                    new ArrayAdapter<String>(ContactListView.this, android.R.layout.simple_dropdown_item_1line,
                        autoContact);
        ...
        while (cursor.moveToNext())
        {
            ...
            Cursor phone =
                cr.query(ContactsContract.CommonDataKinds.Phone.CONTENT_URI,
                    ...
                    null);//再类ContactsContract.CommonDataKinds.Phone中根据查询相应id联系人的所有电话；
            ...
            while (phone.moveToNext())
            {
                ...
                if (!IsContain(contactList, cci.userNumber))
                {
                    if (IsUserNumber(strPhoneNumber))
                    {
                        ...
                        {
                            cci.isChecked = true;
                            numberStr += "," +cci.contactName+":" +cci.userNumber;
                        }
                        contactList.add(cci);
                    }
                }
